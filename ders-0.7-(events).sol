...
// Event’ler, Ethereum blok zincirinde olayları (event) kaydetmek ve uygulama mantığındaki belirli anlarda dış dünyaya sinyal vermek için kullanılır
...
contract Events {
   ...
   //eventler
    ...
    function updateZip(uint256 _orderId, string memory _zip) checkOrderId(_orderId) onlyCustomer(_orderId) incTx external {
        ...
        //Bu kod, bir transfer gerçekleştiğinde event’ini tetikler ve ilgili bilgileri log’lar.
    }
